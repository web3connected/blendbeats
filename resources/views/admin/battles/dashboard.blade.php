@extends('admin.layouts.app', [
    'title' => 'Battle Admin',
    'heading' => 'Battle Admin Dashboard',
    'subtitle' => 'Battle control room for battle activity, token economy, escrow health, and admin review.',
])

@section('admin_content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div>
            <h2 class="h5 mb-1">Battle Alerts</h2>
            <p class="text-muted mb-0">Items that need attention in the battle system.</p>
        </div>
